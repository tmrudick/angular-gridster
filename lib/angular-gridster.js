...
angular.module('gridster', [])
   ...
   *
   * @description
   * The `ngGridster` directive waits for all widget DOM elements to be rendered and then creates and exposes a
   ...
   * @param {object} ngGridster An object which contains the base options for gridster.js
  ...
  /*
   * @ngdoc directive
   * @name gridster:ngGridsterRepeat
   *
   * @description
   * The `ngGridsterRepeat` directive instantiates a template once per item from a collection and then emits an event
   ...
   * via the Gridster.js API on the ngGridster directive controller.
   *
   * Must be used as a child of an ngGridster directive.
   *
   * @element ANY
   * @scope
   * @param {repeat_expression} ngGridsterRepeat The expression indicating how to enumerate a collection.
