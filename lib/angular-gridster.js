  ...
  .directive('ngGridster', ['$parse', '$animate', function($parse, $animate) {
    return {
      ...
      link: function(scope, element, attr, ctrl, transclude) {
        var expression = attr.ngGridster, // Get the repeat expression
        ...
        var watcher = scope.$watchCollection(collectionExp, function(collection) {
          ...
          // The "previous node" is the starting element
          var previousNode = element;
          ...
          for (; index < collection.length; index++) {
            ...
            transclude(childScope, function(clone) {
              // Add a comment to the cloned node to denote the end of a repeater
